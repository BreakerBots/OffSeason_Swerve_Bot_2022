...
package BreakerLib.subsystem.cores.drivetrain.differential;

import java.util.function.DoubleSupplier;

import BreakerLib.driverstation.gamepad.controllers.BreakerGenericGamepad;
import BreakerLib.driverstation.gamepad.controllers.BreakerXboxController;
import BreakerLib.util.math.functions.BreakerGenericMathFunction;
