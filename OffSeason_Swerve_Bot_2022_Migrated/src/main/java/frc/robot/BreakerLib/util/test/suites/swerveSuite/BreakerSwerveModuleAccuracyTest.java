...
// public class BreakerSwerveModuleAccuracyTest extends BreakerTestBase{
...
//     private double[] moduleVelocitiesToTest;
//     private Rotation2d[] moduleAnglesToTest;
//     private double totalTestTimeSeconds;
//     public BreakerSwerveModuleAccuracyTest(BreakerSwerveDrive drivetrain, BreakerGenericSwerveModule[] swerveModules, double[] moduleVelocitiesToTest, Rotation2d[] moduleAnglesToTest, double totalTestTimeSeconds, BreakerTestSuiteDataLogType logType) {
...
//         this.moduleVelocitiesToTest = Arrays.copyOf(moduleVelocitiesToTest, moduleAnglesToTest.length);
//         this.moduleAnglesToTest = Arrays.copyOf(moduleAnglesToTest, moduleAnglesToTest.length);
